...
class CooksupColors(
    ...
    fun update(other: CooksupColors) {
    ...
    fun copy(): CooksupColors = CooksupColors(
...
private val DarkColorPalette = CooksupColors(
    brand = Shadow1,
...
private val LightColorPalette = CooksupColors(
    brand = Shadow5,
...
@Composable
fun ProvideCooksupColors(
    colors: CooksupColors,
    ...
    CompositionLocalProvider(LocalCooksupColors provides colorPalette, content = content)
}

private val LocalCooksupColors = staticCompositionLocalOf<CooksupColors> {
    error("No CooksupColorPalette provided")
}


private object CooksupThemeRippleTheme : RippleTheme {
    @Composable
    override fun defaultColor(): Color = CooksupTheme.colors.brand

    @Composable
    override fun rippleAlpha(): RippleAlpha = RippleTheme.defaultRippleAlpha(
        Color.Black, !isSystemInDarkTheme()
    )
}
...
object CooksupTheme {
    val colors: CooksupColors
        @Composable
        get() = LocalCooksupColors.current
}
